...
<table border="0" cellspacing="0" cellpadding="4">
	<tbody>
		...
		<tr>
			...
			<td><?php echo HTML::Encode($type); ?></td>
		</tr>
		<tr>
		...
		<tr>
			<th>&nbsp;</th>
			<td><input type="submit" value="Update Metadata" /> - or - <a href="<?php echo isset($_GET['returnto']) ? HTML::URL($_GET['returnto']) : HTML::URL('clients', 'show', array($clientid)); ?>">Cancel</a></td>
		</tr>
	</tbody>
</table>
